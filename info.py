...
PICS = (environ.get('PICS', 'https://te.legra.ph//file/02c960ef7dc526871637e.jpg https://te.legra.ph//file/4582022cccedbb64da5c8.jpg https://te.legra.ph/file/83f938d5cf01eff30608e.jpg https://te.legra.ph/file/68bd7afba3137074b3115.jpg https://te.legra.ph/file/09b7bd1349a2b5a60983c.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://te.legra.ph/file/a27dc8fe434e6b846b0f8.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://te.legra.ph/file/236b438b36ec74b559b7e.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/6d892cfe330844916d86f.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001747994613'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5207138613 5533079371').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001866646571 -1002043045800 -1001734720021 -1001962098016').split()]
...
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), True) #link mode 
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'b2da06188bd355e103d16ab1b56db314709740df')
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'tnshort.net')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', '9bccb0b14ed6841652fa22d3481907788c1b8838')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/links_tutorialbypp/25')
...
MSG_ALRT = environ.get('MSG_ALRT', 'sᴜʙsᴄʀɪʙᴇ, sʜᴀʀᴇ & sᴜᴘᴘᴏʀᴛ ᴜs')
...
QUALITIES = ["HdRip","web-dl" ,"bluray", "hdr", "fhd" , "240p", "360p", "480p", "540p", "720p", "960p", "1080p", "1440p", "2K", "2160p", "4k"]
