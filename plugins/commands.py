...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('💐SᑌᑭᑭOᖇT💐', url="https://t.me/+or1WA716YBc5MTVl"),
            InlineKeyboardButton('🌿ᑌᑭᗪᗩTE🍀', url='https://t.me/infinity_botzz')
        ],[
            InlineKeyboardButton('🍿 ᒍOIᑎ ᖴOᖇ ᖴᖇEE ᗰOᐯIES 🍿', url=CHNL_LNK)
        ]]
            ...
            try:
                ...
                if STREAM_MODE == True:
                    button = [[
                        ...
                        InlineKeyboardButton('𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥', url="https://t.me/mpbotzsupport_bot")
                    ],[
        ...
        for file in files:
            ...
            if STREAM_MODE == True:
                button = [[
                    ...
                    InlineKeyboardButton("𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥", url="t.me/mpbotzsupport_bot")
                ],[
                    InlineKeyboardButton('🚀 Fast Download / Watch Online🖥️', callback_data=f'generate_stream_link:{file_id}') #Don't change anything without contacting me @mpbotzsupport_bot
                ]]
            else:
                button = [[
                    InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url=f'https://t.me/{SUPPORT_CHAT}'),
