...
async def pm_text(bot, message):
    ...
    if PM_SEARCH == True:
        ...
        await message.reply_text(text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href='https://t.me/+BJfqwUjbkQFmNTU1'>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ\n\n🏷️ Jᴏɪɴ ᴀɴᴅ Sᴇᴀʀᴄʜ Hᴇʀᴇ ♲︎︎︎</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/+BJfqwUjbkQFmNTU1")]]))
...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn.insert(0, [
            InlineKeyboardButton("ɢᴇᴛ ᴀʟʟ", callback_data=f"sendfiles#{key}"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        await query.answer(text=script.NORENAMEINFO, show_alert=True)
        ...
        buttons = [[
             ...
             InlineKeyboardButton('sᴛʀᴇᴀᴍ/ᴅᴏᴡɴʟᴏᴀᴅ', callback_data='s_txt') #InlineKeyboardButton('ʀᴇɴᴀᴍᴇ', callback_data='renameinfo'), #r_txt
         ], [ 
             ...
             InlineKeyboardButton('ғʙ,ɪɴsᴛᴀ ᴅʟ', callback_data='fb_insta_dl')
         ], [
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.INSTA_TXT.format(temp.U_NAME, temp.B_NAME),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
    ...
    elif query.data == "infinity_support":
        buttons = [[
            InlineKeyboardButton('ꜱᴜʙꜱᴄʀɪʙᴇ  ᴍʏ  ʏᴛ  ᴄʜᴀɴɴᴇʟ', url="https://t.me/hd_movies_hub01/7"),
        ],[
            InlineKeyboardButton('• ɢʀᴏᴜᴘ •', url="https://t.me/+5Ynakjs3OZ5lZDI1"),
            InlineKeyboardButton('• ᴄʜᴀɴɴᴇʟ •', url="https://t.me/+y6sw5OKRsck3OTA1")
        ],[
            InlineKeyboardButton('• ꜱᴜᴘᴘᴏʀᴛ •', url="https://t.me/+JWsoDEJEB9EyNDU1"),
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇꜱ •', url="https://t.me/infinity_botzz")
        ],[
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("≼ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="https://telegram.me/talk_mrs_bot")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
